...
my $sthgmap = $dbh->prepare ("SELECT TAXCD, LTDEC, LGDEC FROM specimenlichen WHERE ACCESSION = '$AccessionParamgmap'");
$sthgmap->execute();
my $LTDECgmapGlobal;
my $LGDECgmapGlobal;
my $taxcdGglobal;
...
print<<"TABLEFOUR";
              ...
              <tr>
                ...
                <td colspan="5">
TABLEFOUR
print("<a href=\"/cgi-bin/lichendetail.cgi?SpCode=$TAXCD\">$TAXCD</a>");
print<<"TABLEFIVE";
                  </a> </td>
              </tr>
TABLEFIVE
	if($ChemistryLN ne "" or $SubstrateLN ne "" or $ColorLN ne "" ){
print<<"TABLESIX";
              <tr>
                <td align="right" bgcolor="#EEEEEE"> <font size=2><b>
                  Chemistry:</b></font>&nbsp; </td>
                <td> 
TABLESIX
print("$ChemistryLN"); 
...
__DATA__
, $id, $ACCESSION, $TYPE, $COLLDATE, $FLOWER, $FRUIT, $STERILE, $OBJTYPE, $INST, $ANNCODE, $ANNDATE, $ANNSOURCE, $CITY, $SITENO, $CITYTYPE, $COLL2NAME, $COLL3NAME, $COLL1NAME, $COLLNO1, $COLLEVENT, $TAXCD, $CFS, $CFV, $CFVariety, $HABITAT_MISC, $HABITAT, $LONGX, $LAT, $ELEV, $LLGENER, $LONG2, $LAT2, $LTDEC, $LGDEC, $NOWLOC, $LOAN, $PAGES, $ORIGCD, $PUBCD, $LITCIT, $PUBDATE, $PUBDATEA, $VERPERS, $VERDATE, $EX, $ARTICLE, $PREC, $STATEL, $COUNTY, $COUNTRY, $T1, $R1, $S1, $NSEW_1, $TRSGENER, $T2, $R2, $S2, $NSEW_2, $PLACE, $scan, $MAPFILE, $username, $date_time, $DTRS, $ChemistryLN, $SubstrateLN, $ColorLN, $PKID
