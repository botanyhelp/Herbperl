...
$hand=~s/H/\/herb\/wwwbotanydev\/herbarium\/wisilchens\/hand\/$SpCodeParam.gif/g;
my $thumbmapsParam = $cgi->param("thumbmaps");
my $thumbmaps = $thumbmapsParam;
$thumbmaps=~s/\.\.\//\/herb\/wwwbotanydev\/herbarium\/wislichens\//g;
...
{ # begin scope
	...
	my $sthfour = $dbh->prepare ("SELECT ACCESSION, TYPE FROM specimenlichen WHERE Taxcd = '$SpCodeParam' AND scan = '1'");
	$sth->execute();
	$sthtwo->execute();
	$sththree->execute();
	$sthfour->execute();
#start looping through the link table query results:
 	while(my ($Type, $Taxcd, $Link, $Title, $Description, $link_id) = $sthtwo->fetchrow_array()) {
		...
		if($Type=~/3/){
			...
			$dotmapsstring = "<a href=\"/herb/wwwbotanydev/herbarium/wislichens/dots/$SpCodeParam.gif\"><img src=\"/herb/wwwbotanydev/herbarium/wislichens/thumbmap/$SpCodeParam.gif\"></a><br><a href=\"/herb/wwwbotanydev/herbarium/wislichens/dots/$SpCodeParam.gif\">View specimen location map</a>";
			$dot_url = "<a href=\"/herb/wwwbotanydev/herbarium/wislichens/dots/$SpCodeParam.gif\">$Title</a><font size=-1>$Description</font>";
			$dot_exists = 1;
		}elsif($Type=~/1b/){
			$handstring = "<a href=\"/herb/wwwherbarium/wislichens/photos/handmap/$SpCodeParam.gif\"><img src=\"/herb/wwwbotanydev/herbarium/wislichens/thumbmap/$SpCodeParam.gif\"></a><br><a href=\"/herb/wwwherbarium/wislichens/photos/handmap/$SpCodeParam.gif\">View specimen location map</a>";
			$hand_url = "<a href=\"/herb/wwwherbarium/wislichens/photos/handmap/$SpCodeParam.gif\">$Title</a> <font size=-1> $Description</font>";
			$hand_exists = 1;
		}elsif($Type=~/4/){
...
# 	while (($spdetail_Taxcd, $spdetail_Syncd, $spdetail_family_code, $spdetail_genus, $spdetail_species, $spdetail_authority, $spdetail_subsp, $spdetail_variety, $spdetail_forma, $spdetail_subsp_auth, $spdetail_var_auth, $spdetail_forma_auth, $spdetail_sub_family, $spdetail_tribe, $spdetail_common, $spdetail_Wisc_found, $spdetail_ssp, $spdetail_var, $spdetail_f, $spdetail_hybrids, $spdetail_status_code, $spdetail_hide, $spdetail_USDA, $spdetail_COFC, $spdetail_WETINDICAT, $spdetail_FAM_NAME, $spdetail_FAMILY, $spdetail_GC, $spdetail_FAMILY_COMMON, $spdetail_SYNWisc_found, $spdetail_SYNS_STATUS, $spdetail_SYNV_STATUS, $spdetail_SYNF_STATUS, $spdetail_SYNHYBRIDS_STATUS, $spdetail_SYNW_STATUS, $spdetail_speciesweb_Taxcd, $spdetail_Status, $spdetail_Photo, $spdetail_Photographer, $spdetail_Thumbmaps, $spdetail_Accgenus, $spdetail_SORTOR, $spdetail_Hand, $spdetail_growth_habit_bck, $spdetail_blooming_dt_bck, $spdetail_origin_bck, $spdetail_Thumbphoto, $spdetail_date_time, $spdetail_growth_habit, $spdetail_blooming_dt, $spdetail_origin, $spdetail_Taxa, $spdetail_spdetail_id) = $sth->fetchrow_array ()){
 	while (($spdetail_Taxcd, $spdetail_Syncd, $spdetail_family_code, $spdetail_genus, $spdetail_species, $spdetail_authority, $spdetail_subsp, $spdetail_variety, $spdetail_forma, $spdetail_subsp_auth, $spdetail_var_auth, $spdetail_forma_auth, $spdetail_sub_family, $spdetail_tribe, $spdetail_common, $spdetail_Wisc_found, $spdetail_ssp, $spdetail_var, $spdetail_f, $spdetail_hybrids, $spdetail_status_code, $spdetail_hide, $spdetail_USDA, $spdetail_COFC, $spdetail_WETINDICAT, $spdetail_FAM_NAME, $spdetail_FAMILY, $spdetail_GC, $spdetail_FAMILY_COMMON, $spdetail_SYNWisc_found, $spdetail_SYNS_STATUS, $spdetail_SYNV_STATUS, $spdetail_SYNF_STATUS, $spdetail_SYNHYBRIDS_STATUS, $spdetail_SYNW_STATUS, $spdetail_speciesweb_Taxcd, $spdetail_Status, $spdetail_Photo, $spdetail_Photographer, $spdetail_Thumbmaps, $spdetail_Accgenus, $spdetail_SORTOR, $spdetail_Hand, $spdetail_growth_habit_bck, $spdetail_blooming_dt_bck, $spdetail_origin_bck, $spdetail_Thumbphoto, $spdetail_date_time, $spdetail_growth_habit, $spdetail_blooming_dt, $spdetail_origin, $spdetail_Taxa, $spdetail_growthform, $spdetail_photobiont, $spdetail_abundance, $spdetail_Gallery, $spdetail_spdetail_id) = $sth->fetchrow_array ()){
...
#TTTLICHENSTART
	if($spdetail_Gallery ne "") {
		print $cgi->p("$spdetail_Gallery\n");
	}
	if($spdetail_growthform ne "") {
		print $cgi->p("Growth Form: $spdetail_growthform\n");
	}
	if($spdetail_photobiont ne "") {
		print $cgi->p("Photobiont: $spdetail_photobiont\n");
	}
	if($spdetail_abundance ne "") {
		print $cgi->p("Abundance: $spdetail_abundance\n");
	}
#TTTLICHENSTOP
...
TABLETHREE
	...
	#print $cgi->a({-href=>"/cgi-bin/lichensearchspecimen.cgi?SpCode=".$cgi->escape($spdetail_Taxcd)."&Genus=".$cgi->escape($spdetail_genus)."&Family=".$cgi->escape($spdetail_FAMILY)."&Species=".$cgi->escape($spdetail_species)."&Common=".$cgi->escape($spdetail_common)}, "View Herbarium Records");
	print $cgi->a({-href=>"/cgi-bin/lichensearchspecimen.cgi?SpCode=".$cgi->escape($spdetail_Taxcd)}, "View Herbarium Records");
...
#________________________________________________________________________________
	if($Photo ne "") {
		$Photo=~s/\.\.\/photos/\/herb\/wwwherbarium\/wislichens\/photos\/xl_photos\//g;
		my $MainPhoto = $Photo;
		$MainPhoto=~s/xl_photos//g;
	...
	if($length_of_photos > 0) {
		...
		# uninitialized value 439 461 462 in subsititutions/// and comparison ne
			...
			if($photos[$i+1] ne ""){
				...
				my $D = $photos[$i+2];
				my $Thumb = $T;
				$Thumb=~s/\.\.\//\/herb\/wwwherbarium\/wisflora\/photos\//g;
				#$L=~s/\.\.\/bigphoto/\/herb/wwwherbarium\/wislichens\/photos\/xl_photos\//g;
				$L=~s/\.\.\/bigphoto/\/herb\/wwwherbarium\/wislichens\/photos\/photo\//g;
...
TABLESEVENTWO
		...
		print("<a href=\"/RequestPhoto.html\">No photograph available -<br> We request that you submit a photo</a><br>");
	}
